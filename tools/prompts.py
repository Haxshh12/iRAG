...
prompt_template = PromptTemplate(
    ...
    The embeddings are created using Google Gemini API.
...
context = """Purpose: The primary role of this agent is to assist users by providing accurate 
            information regarding a comprehensive collection of blog posts sourced from Medium.
            The answer has to be short and focused on answering the question only. 
